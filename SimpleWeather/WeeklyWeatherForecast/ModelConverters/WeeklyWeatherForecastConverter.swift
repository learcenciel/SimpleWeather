...
class WeeklyWeatherForecastConverter {
    ...
    private func checkWeatherResponse(_ hourlyTemperatures: HourlyTemperatureInfo, _ calendar: Calendar) -> Bool {
        ...
        return responseDay >= currentDay + 1 && responseDay <= currentDay + 4 &&
